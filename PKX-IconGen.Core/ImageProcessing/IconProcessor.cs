...
{
    private RenderJob Job { get; }
    private bool HasSecondary => Job.Data.FaceRender.SecondaryCamera.HasValue;

    private string OutputPath { get; }
        
    private bool SaturationBoost { get; }
        
    private bool SaveDanceGIF { get; }
        
    private Game NameForGame { get; }
    private TextureTargetChoice NameTarget { get; }
